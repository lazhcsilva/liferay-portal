...
UpgradeJavaCommerceAccountGroupRelLocalServiceCheck | [Upgrade](upgrade_checks.markdown#upgrade-checks) | Replaces method addCommerceAccountGroupRel by addAccountGroupRel |
