...
UpgradeCommerceOrderConstantsCheck | [Upgrade](upgrade_checks.markdown#upgrade-checks) | Replace departed constants of CommerceOrderConstants by CommerceOrderPaymentConstants equivalents |
