...
UpgradeJavaCommerceAccountGroupRelLocalServiceCheck | .bnd, .ftl, .gradle, .java, .json, .jsp, .jspf, .scss or .vm | Replaces method addCommerceAccountGroupRel by addAccountGroupRel |
