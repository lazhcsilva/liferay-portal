...
UpgradeCommerceOrderConstantsCheck | .bnd, .ftl, .gradle, .java, .json, .jsp, .jspf, .scss or .vm | Replace departed constants of CommerceOrderConstants by CommerceOrderPaymentConstants equivalents |
